        ...
        <>
            ...
            <tr className="hover:bg-gray-50">
                ...
                <div className="text-sm">
                    <div className="font-medium text-gray-700">{author_name}</div>
                ...
                <td className="px-6 py-4">{post_title}</td>
                <td className="px-6 py-4">
                    <span className="inline-flex items-center gap-1 rounded-full bg-blue-50 px-2 py-1 text-xs font-semibold text-blue-600">0</span>
