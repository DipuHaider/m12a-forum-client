const PostCard = () => {
    return (
        <div className="card card-side bg-base-100">
                <div className='flex items-center justify-center'>  <div className="rounded-xl border p-5 shadow-md w-11/12 bg-white">
                    ...
                    <div className="mb-3 text-xl font-bold text-theme-primary">Nulla sed leo tempus, feugiat velit vel, rhoncus neque?</div>
