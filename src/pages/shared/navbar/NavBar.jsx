...
const NavBar = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto navbar sticky inset-x-0 top-0 z-50 text-black">
            <div className="navbar-start">
                ...
                <a href="/"><div className="flex"><FaAtom  className="text-4xl text-theme-primary"></FaAtom >&nbsp;<span className="py-2 text-theme-dark text-xs md:text-2xl font-extrabold italic">Dev&nbsp;</span><span className="py-2 text-theme-primary text-xs md:text-2xl font-extrabold italic">Forum</span>
                    </div></a>
            </div>
