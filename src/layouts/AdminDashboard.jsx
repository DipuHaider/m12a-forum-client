  ...
  <div className="py-6 px-5 w-1/6">
    {/* <div className="flex space-2 items-center border-b-2 pb-4">
      ...
      <div className="ml-3">
        ...
        <p className="text-center text-sm text-indigo-600 mt-1 font-serif">Admin Dashboard</p>
      </div>
    </div> */}
    ...
    <div className="mt-8">
      <ul className="space-y-10">
        ...
        <li>
          <a href="#" className="flex items-center text-sm font-semibold text-gray-500 hover:text-indigo-600 transition duration-200" hover:text-indigo-600>
    ...
    <div className="flex mt-20 space-x-4 items-center">
      ...
      <a href="#" className="block font-semibold text-gray-500 hover:text-indigo-600 transition duration-200">Logout</a>
    </div>
  </div>
  <div className="bg-indigo-50 flex-grow py-12 px-10">
    <div className="flex justify-between">
      <div>
        <h4 className="text-sm font-bold text-indigo-600">Hi, {user?.displayName}</h4>
              ...
              <tr className="bg-white border-4 border-gray-200 text-center">
                ...
                <td className="px-16 py-2">
                  <span className="text-yellow-500">
                    <svg xmlns="http://www.w3.org/2000/svg" className="w-5 h-5" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
                      <path stroke="none" d="M0 0h24v24H0z" />
